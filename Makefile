...
install: launch
	...
	@sudo cp switcher.py windowcontrol.py listfilter.py tabcontrol.py pidfile.py glib_wrappers.py keycodes.py launch browser-agent/api_proxy_native_app.py ${INSTALL_DIR} >> installation.log 2>&1
